...
Bot: Debales AI offers several specialized AI agents including
     Email AI Agent, SMS AI Agent, WhatsApp AI Agent...
```
...
→ Route: DEBALES
→ Retrieving from knowledge base...
Bot: Debales AI differs from other AI companies in that it has
     reached $1 million in revenue with zero external funding...
```
